...
public class LoginTestNew extends TestBase{
	...
	public void loginTest(User user){
		...
		assertEquals(hp.goToLoginPage().doLoginWith(user.getEmailAddress(),user.getPassword()).getUsername(),"R g");		
...
//
//		assertEquals(hp.goToLoginPage().doLoginWith(user.getEmailAddress(),user.getPassword()).getUsername(),"R g1");
//		
//		}
